...
const PaymentSecurity = () => {
  ...
  const handleCountryBlock = (countryCode, block) => {
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Manage payment security policies
                  </p>
                </div>
              </div>
            </div>
            <Badge variant="secondary" className="bg-green-100 text-green-800">
              <Shield className="h-3 w-3 mr-1" /> Security Active
            </Badge>
          </div>
        </div>
      </header>
          ...
          <CardContent className="space-y-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {[{
                ...
                key: "blockHighRiskCountries",
                desc: "Automatically block payments from high-risk regions",
              },
              {
                label: "Velocity Checks",
                key: "enableVelocityChecks",
                desc: "Monitor transaction frequency and amounts",
              },
              {
                label: "Strong Authentication",
                key: "requireStrongAuth",
                desc: "Require 2FA for high-value transactions",
              },
              {
                label: "Device Fingerprinting",
                key: "enableDeviceFingerprinting",
                desc: "Track and analyze device characteristics",
              },
              {
                label: "Block VPN/Tor",
                key: "blockVpnTor",
                desc: "Prevent payments from anonymized networks",
              },
              {
                label: "Geo-blocking",
                key: "enableGeoBlocking",
                desc: "Location-based payment restrictions",
              }].map((item, index) => (
                <div
                  key={index}
              ...
              >
                <div className="flex items-center space-x-4">
                  <div
                    className={`w-3 h-3 rounded-full ${
                      country.blocked ? "bg-red-500" : "bg-green-500"
                    }`}
                  />
                  <div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      handleCountryBlock(country.code, !country.blocked)
                    }
                  >
                    {country.blocked ? (
                      <>
