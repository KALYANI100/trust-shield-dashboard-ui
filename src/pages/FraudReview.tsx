    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              {flaggedTransactions.map((transaction) => (
                <div key={transaction.id} className="p-6 bg-gray-50 rounded-lg border border-gray-300">
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center space-x-4">
                      <div className={`w-4 h-4 rounded-full ${getRiskColor(transaction.riskScore)}`} />
                      <div>
                        <p className="font-semibold text-gray-900">Transaction #{transaction.id}</p>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>Detailed analysis of this flagged transaction</DialogDescription>
        </DialogHeader>
        <div className="space-y-3 text-sm text-gray-700">
          ...
          <p><strong>Risk Score:</strong> {selectedTransaction?.riskScore}% ({getRiskLabel(selectedTransaction?.riskScore || 0)})</p>
          <p><strong>Reason Flagged:</strong> {selectedTransaction?.reason}</p>
